...
const InputShelter = ({ updateEntry }) => {
  ...
  const handleSelectTime = (shelter) => {
    updateEntry("shelter", `Shelter ${shelter}`);
    navigate("/inputjarak");
  };
      ...
      <div className="flex justify-center items-center min-h-screen">
        <div className="px-[30px] py-[30px] flex flex-col items-center text-center">
          ...
          <div className="mt-[40px] flex justify-center space-x-20">
            <button
              className="btn bg-[#cc0000] text-white hover:bg-white hover:text-[#cc0000] border-none px-[30px] sm:px-[50px]"
              onClick={() => handleSelectTime("A")}
            >
              A
            </button>
            <button
              className="btn bg-[#cc0000] text-white hover:bg-white hover:text-[#cc0000] border-none px-[30px] sm:px-[50px]"
              onClick={() => handleSelectTime("B")}
            >
              B
            </button>
            <button
              className="btn bg-[#cc0000] text-white hover:bg-white hover:text-[#cc0000] border-none px-[30px] sm:px-[50px]"
              onClick={() => handleSelectTime("C")}
            >
              C
            </button>
          </div>
